				...
				<div class="row">
					<div class="col-md-8 col-md-offset-2 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0 text-center fh5co-table">
						<div class="fh5co-intro fh5co-table-cell animate-box">
							<h1 style="margin-top:100 px !important" class="text-center">Ginástica funcional</h1>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="row">
						<div class="col-md-12 animate-box">
							<div class="row" style="font-family: Roboto, Arial, sans-serif !important">
								A ginástica funcional é uma aula de ginástica focada em mulheres e em não gerar lesões nos alunos, trazendo os benefícios das atividades físicas. É comandada pela atleta da seleção brasleira de Taekwondo Sabrina Teis.
							</div>
						</div>
					</div>
			</div>
