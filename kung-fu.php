...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <!-- 
	...
	<body>
				...
				<div class="row">
					<div class="col-md-8 col-md-offset-2 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0 text-center fh5co-table">
						<div class="fh5co-intro fh5co-table-cell animate-box">
							<h1 class="text-center">Kung-Fu</h1>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="row">
						<div class="col-md-12 animate-box">
							<div class="row" style="font-family: Roboto, Arial, sans-serif !important">
								As aulas de Kung Fu são dadas pelo professor Welton Vagner. A aula é puxada se o aluno quiser, mas vamos no seu ritmo!
							</div>
						</div>
					</div>
			</div>
		...
		<div class="slider">
			<ul>
				<li><img src="images/kung-fu/kung-fu.jpg" /></li>
				<li><img src="images/kung-fu/kung-fu2.jpg" /></li>
				<li><img src="images/kung-fu/kung-fu3.jpg" /></li>
				<li><img src="images/kung-fu/1.jpg" /></li>
				<li><img src="images/kung-fu/2.jpg" /></li>
				<li><img src="images/kung-fu/3.jpg" /></li>
				<li><img src="images/kung-fu/4.jpg" /></li>
			</ul>
		</div>
