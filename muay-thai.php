				...
				<div class="row">
					<div class="col-md-8 col-md-offset-2 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0 text-center fh5co-table">
						<div class="fh5co-intro fh5co-table-cell animate-box">
							<h1 style="margin-top:100 px !important" class="text-center">Muay Thai</h1>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="row">
						<div class="col-md-12 animate-box">
							<div class="row" style="font-family: Roboto, Arial, sans-serif !important">
								Cotoveladas? Joelhadas? Dente caindo? Aqui não temos pessoas machucadas e os golpes são ensinados conforme o aluno quer e pode aprender. O professor é uma pessoa extremamente calma e colabora com a evolução dos alunos!
							</div>
						</div>
					</div>
			</div>
